  ...
  if(stride_ > 0)
    {
      ...
      convert_collection_data_to_soa_(hits_ee, kmdata_);
...
void HeterogeneousHGCalEERecHitProducer::convert_collection_data_to_soa_(const edm::SortedCollection<HGCUncalibratedRecHit>& hits, KernelModifiableData<HGCUncalibratedRecHitSoA, HGCRecHitSoA>* kmdata)
{
...
void HeterogeneousHGCalEERecHitProducer::convert_soa_data_to_collection_(HGCRecHitCollection& rechits, KernelModifiableData<HGCUncalibratedRecHitSoA, HGCRecHitSoA>* kmdata)
{
