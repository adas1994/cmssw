...
public:
  ...
  void accumulate_minbias(edm::Event const&, edm::EventSetup const&) ;
  void accumulate_minbias(PileUpEventPrincipal const&, edm::EventSetup const&, edm::StreamID const&) ;
  void accumulate(edm::Event const&, edm::EventSetup const&) override;                                                            
  void accumulate(PileUpEventPrincipal const&, edm::EventSetup const&, edm::StreamID const&) override;
