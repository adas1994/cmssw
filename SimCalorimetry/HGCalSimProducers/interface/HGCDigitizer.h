...
#include "DataFormats/HGCDigi/interface/PreMixSimAccumulator.h"
...
public:
  ...
  void accumulate(const PHGCSimAccumulator& simAccumulator);
  void accumulate_forPreMix(const PreMixSimAccumulator& simAccumulator, const bool& minbiasFlag);//, const GEOM* geom);
  /**
