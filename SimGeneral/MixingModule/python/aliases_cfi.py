...
(premix_stage1 & phase2_hgcal).toModify(simHGCalUnsuppressedDigis,
                                        mix = simHGCalUnsuppressedDigis.mix + {
                                            simHGCalUnsuppressedDigis.mix[0].clone(type = "CnTSimAccumulator"),
                                            simHGCalUnsuppressedDigis.mix[1].clone(type = "CnTSimAccumulator"),
                                            simHGCalUnsuppressedDigis.mix[2].clone(type = "CnTSimAccumulator"),
                                        }
)
